...
import QAiContentCard from "./QAiContentCard";
...
export default function QAiContainer() {
...
const handleGenerate = async ({
  ...
  if (promptLower.includes("who made you") || promptLower.includes("who created you")) {
    setContent({
      content: "I was lovingly crafted by a bunch of smart, sleep‑deprived teens 💻❤️ Just for curious learners like you!",
      contentType: 'answer',
    });
    return;
  }
  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <QAiContentCard content={content} />
      ) : (
        <div className="flex flex-col items-center justify-center bg-muted/30 rounded-lg p-8 min-h-64">
          <Book className="h-12 w-12 text-muted-foreground mb-4" />
          <p className="text-center text-lg font-medium mb-2">Ready to learn with Q.AI</p>
